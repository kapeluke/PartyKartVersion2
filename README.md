...
1. Provide accurate estimates to the user depending on their choice of hyperparameters, $P$, and $N$, how how the solver might actually take to solve the problem. This is lower priority and requires potentially profiling the code in a sort of 'hyperparameter sensititvity' table and inter/extrapolating between values
